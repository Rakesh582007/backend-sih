...
# Renamed from the original ["tilt", "water_level"] to match the real,
# reconciled field names in schema.json (slope_pitch_deg, stream_depth_cm)
# as part of the merge — same channels, same self-healing algorithm below
# is completely unchanged, only the column names moved.
FLAG_ONLY_CHANNELS = ["slope_pitch_deg", "stream_depth_cm"]
